...
# CLTV için hangi metriklere ihtiyacımız var?
# recency: Son satın alma ile ilk satın alma arasındaki süre. Haftalık. (kullanıcı özelinde)
...
# 2.  Gamma-Gamma modelini fit ediniz. Müşterilerin ortalama bırakacakları değeri tahminleyip exp_average_value olarak cltv dataframe'ine ekleyiniz.
# recency ve monetary metriklerine ihtiyacım var.
...
# 3. 6 aylık CLTV hesaplayınız ve cltv ismiyle dataframe'e ekleyiniz.
# customer_lifetime_value fonksiyonu gamma-gamma modeli ve bgnbd modelini ister.
# Bununla birlikte hangi metrikler üzerinden hesaplayacaktık?
